...
<div class="alert alert-primary" role="alert">
    <h4 class="alert-heading" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: bold">
        現在の運行状況 / Current operation status</h4>
...
<div class="accordion" id="accordions" role="tablist">
    ...
    <div class="card-header" role="tab" id="heading1">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #F62E36;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading2">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #8F76D6;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading3">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #B5B5AC;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading4">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #00BB85;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading5">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #FF9500;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading6">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #009BBF;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading7">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #00AC9B;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading8">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #9C5E31;" class="text-body stretched-link text-decoration-none"
    ...
    <div class="card-header" role="tab" id="heading9">
        <h5 class="mb-0">
            <a data-toggle="collapse" style="color: #C1A470;" class="text-body stretched-link text-decoration-none"
